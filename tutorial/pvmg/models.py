...
class DataPvmgBuffer(models.Model):
    ...
    llxyggl = models.DecimalField(db_column='LLXYGGL', max_digits=15, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    llxwggl = models.DecimalField(db_column='LLXWGGL', max_digits=15, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    pcsscgl = models.DecimalField(db_column='PCSSCGL', max_digits=15, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    pcspl = models.DecimalField(db_column='PCSPL', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    lizdy = models.DecimalField(db_column='LIZDY', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    lizdl = models.DecimalField(db_column='LIZDL', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    lisoc = models.DecimalField(db_column='LISOC', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    lisoh = models.DecimalField(db_column='LISOH', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
...
class DataPvmgHistory(models.Model):
    datatime = models.DateTimeField(db_column='DATATIME', primary_key=True)  # Field name made lowercase.
    systemcode = models.CharField(db_column='SYSTEMCODE', max_length=32)  # Field name made lowercase.
    ...
    ljfdl = models.DecimalField(db_column='LJFDL', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    jrfdl = models.DecimalField(db_column='JRFDL', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    hjwd = models.DecimalField(db_column='HJWD', max_digits=15, decimal_places=4, blank=True,
                               null=True)  # Field name made lowercase.
    rz = models.DecimalField(db_column='RZ', max_digits=15, decimal_places=4, blank=True,
                             null=True)  # Field name made lowercase.
    ...
    co2jp = models.DecimalField(db_column='CO2JP', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    fzhdl = models.DecimalField(db_column='FZHDL', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    fzzgl = models.DecimalField(db_column='FZZGL', max_digits=15, decimal_places=4, blank=True,
                                null=True)  # Field name made lowercase.
    llxyggl = models.DecimalField(db_column='LLXYGGL', max_digits=15, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    llxwggl = models.DecimalField(db_column='LLXWGGL', max_digits=15, decimal_places=4, blank=True,
